...
function renderPathPreview(habit) {
  ...
  return `<button class="path-preview" type="button" data-action="open-path"><span><b>Learning path</b> ${phase.number} · ${phase.title}</span> <small>Next · ${nextStep}</small></button>`;
}
